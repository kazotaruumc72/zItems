...
public class OraxenHook implements Hook {
    ...
    public void onEnable() {
        Registry.get(CustomBlockProviderRegistry.class).register("oraxen", new OraxenBlockProvider());
        Registry.get(ItemProviderRegistry.class).register("oraxen", new OraxenItemProvider());
    }

    private record OraxenBlockProvider() implements CustomBlockProvider {
    ...
    private record OraxenItemProvider() implements ItemProvider {
